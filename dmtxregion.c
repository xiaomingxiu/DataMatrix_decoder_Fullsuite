														...
														dmtxRegionScanPixel(DmtxDecode *dec, int x, int y)
														{
														   ...
														   /* Determine barcode orientation */
								   						   ...
								   						   if(MatrixRegionOrientation(dec, &reg, flowBegin) == DmtxFail)      // 1.5s  Xiu added here
														      return NULL;


//===========================================
//================xiu add here=========
DmtxTime start=dmtxTimeNow();

printf("start MatrixRegionOrientation!\n");
//=================add end ===================
//===========================================		
														   ...
														   if(MatrixRegionFindSize(dec, &reg) == DmtxFail)  // 400 ms xiu added here
														      return NULL;
...
//==========================================
//================xiu add here=========
DmtxTime end=dmtxTimeNow();

double delta_time=(double)( end.sec -start.sec) + ((double)(end.usec)- (double)(start.usec))*0.000001;
